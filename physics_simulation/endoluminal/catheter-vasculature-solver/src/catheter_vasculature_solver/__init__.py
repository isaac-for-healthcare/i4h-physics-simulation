...
#   - cath_rod_solver: vessel mesh collision extension — catheter-in-vessel containment + track guidance
...
from .vessel_config import VesselConfig, VesselDeformationConfig
